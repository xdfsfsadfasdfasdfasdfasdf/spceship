...
import { Color, PositionFlags, PhysicsFlags, StyleFlags } from "../src/Const/Enums";
import { BarrelBase } from "./TankBody";
import { addonId, BarrelDefinition } from "../src/Const/TankDefinitions";
import { AI, AIState, Inputs } from "./AI";
import LivingEntity from "./Live";
import { normalizeAngle, PI2 } from "../src/util";
...
export class Addon {
    ...
    protected createAutoTurrets(count: number) {
        ...
        rotator.scaleFactor = this.owner.scaleFactor;
        rotator.turrets = [];
